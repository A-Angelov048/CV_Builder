...
export default function EducationStatic() {
      ...
      <div ref={refView} className={styles.timeline}>
        <div className={styles["timeline-item"]}>
          ...
          >
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero necessitatibus quas,
              accusantium expedita culpa, vero esse ipsum numquam minima alias praesentium magnam
              magni cum at minus ad? Modi, nihil ab.
            </p>
          </div>
        </div>
        ...
        <div className={styles["timeline-item"]}>
          ...
          >
            ...
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. At labore, vitae vel ducimus
              amet incidunt, officiis quas nesciunt minus reiciendis eius temporibus eaque,
              excepturi obcaecati hic nulla atque neque reprehenderit!
            </p>
          </div>
        </div>
